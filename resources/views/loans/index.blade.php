        ...
        <div class="container-fluid py-4">
            <div class="row">
                <div class="col-12">
                    <div class="card my-4">
                        <div
                            class="card-header p-0 position-relative mt-n4 mx-3 z-index-2 grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                            ...
                            <div class="flex justify-between items-center pt-1 px-r row">
                                <div class="space-x-2 col-md-8">
                                    <a href="{{ route('loans.create') }}"
                                        class="btn btn-lg bg-gradient-secondary btn-sm w-14">
                                        <span class="material-icons text-sm me-1">create</span> Crear Prestamo
                                    </a>
                                    <a href="{{ route('reportloan.index') }}"
                                        class="btn btn-lg bg-gradient-secondary btn-sm w-12">
                                        <span
                                            class="material-symbols-outlined text-sm me-1">picture_as_pdf</span>Generar
                                        Reporte
                                    </a>
                                </div>
                                <!-- Formulario de búsqueda -->
                                <form action="{{ route('loans.search') }}" method="GET">
                                    <div class="input-group input-group-outline">
                                        <input type="text" class="form-control" name="search"
                                            placeholder="Buscar...">
                                        <button type="submit" class="btn bg-gradient-secondary btn-sm">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex px-2">
                                                            <div class="my-auto">
                                                                <h6 class="mb-0 text-sm">{{ $loan->customer->name }}
                                                                </h6>
                                                            </div>
                                                        </div>
                                                    </td>
